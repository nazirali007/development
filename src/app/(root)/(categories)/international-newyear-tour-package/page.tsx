...
import TripsShower from "@/components/trips-shower-filters";
...
export async function generateMetadata() {
	const strapiContent = await getStrapiCatergoryContent({ slug: "international-newyear-tour-package" });
	...
	return {
		...
		description: strapiContent.metadescription ? strapiContent.metadescription : '',
		keywords: keywords || '',
		alternates: {
...
export default async function Page() {
	...
	const data = await categoryData({ slug: "international-newyear-tour-package" })
	if (!data) {
