...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn('h-8 w-8 rounded-md bg-slate-400 p-1 opacity-50 transition-all duration-300 ease-in-out hover:opacity-100',
        `${className}`)}>
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-right h-full w-full"><path d="m9 18 6-6-6-6"></path></svg>
